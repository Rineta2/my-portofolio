...
export default function TestimonialsClient({ testimonials: initialTestimonials }) {
    ...
    const { testimonials, submitTestimonial, hasUserSubmitted } = useTestimonials(initialTestimonials);
        ...
        <div className={`${styles.container} ${styles.testimonials__container}`}>
            ...
            <div className={styles.btn}>
                {!hasUserSubmitted(user?.uid) && (
                    <button onClick={handleAddClick} className={styles.add_testimonial_button}>
